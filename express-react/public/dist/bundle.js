...
/***/ function(module, exports, __webpack_require__) {
	  ...
	  render : function () {
	    return (
	      React.createElement("div", null, 
	        React.createElement(CommentList, {commetData: this.state.data}), 
	...
	var CommentList = React.createClass({displayName: "CommentList",
	  render:function(){
	    ...
	    var commentNodes = this.props.commetData.map(function(one){
	      return (
	        React.createElement(Comment, {author: one.author, key: one.id}, 
	          one.text
	        )
	      )
	    })
	    ...
	    return (
	      React.createElement("div", null, 
	          React.createElement("div", {className: "mt10"}, 
	            "姓名：", React.createElement("input", {type: "text", onChange: this.handleAuthor})
	          ), 
	          React.createElement("div", {className: "mt10"}, 
	            "内容：", React.createElement("input", {type: "text", onChange: this.handleText})
	          ), 
	          React.createElement("div", {className: "mt10"}, 
	            React.createElement("input", {type: "button", value: "发表", onClick: this.submit})
	          )
	      )
	    )
	  }
	...
	var Counter = React.createClass({displayName: "Counter",
	  ...
	  render : function () {
	    return (React.createElement("h2", {onClick: this.handleClick}, "点击次数为：", this.state.clickCount))
	  }
	});
	ReactDOM.render(
